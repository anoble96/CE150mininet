...
class final_topo(Topo):
  def build(self):
    ...
    h6 = self.addHost ('h6', mac='00:00:00:00:00:06', ip='10.0.3.2/24', defaultRoute="h6-eth0")
    h7 = self.addHost ('h7', mac='00:00:00:00:00:07', ip='10.0.4.1/24', defaultRoute="h7-eth0")
    ...
    # Connect Subnet Switches to Switch 1
    self.addLink(s2, s1, port1=1, port2=2)
    self.addLink(s3, s1, port1=1, port2=3)
    self.addLink(s4, s1, port1=1, port2=4)
    self.addLink(s5, s1, port1=1, port2=5)
